...
import { Player } from "./football-api";
...
const MintedPlayersContext = createContext<
  MintedPlayersContextType | undefined
>(undefined);
...
export function useMintedPlayers() {
  ...
  if (context === undefined) {
    throw new Error(
      "useMintedPlayers must be used within a MintedPlayersProvider"
    );
  }
  return context;
}
